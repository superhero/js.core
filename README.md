...
The framework will add services depending on a hierarchy of paths, it's possible to write over the configuration done by one component in another. This feuture allows the developer to extend, or build on to, components decalered functionality.
